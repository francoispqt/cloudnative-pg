...
`failoverDelay        ` | The time in seconds a primary PostgreSQL instance should be deemed unhealthy before triggering a failover                                                                                                                                                                                                                                                                                                               | int32                                                                                                                           
...
`currentPrimaryFailingSince` | The timestamp when the current primary was deemed unhealthy                                                                                                                        | [*metav1.Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.21/#time-v1-meta)
